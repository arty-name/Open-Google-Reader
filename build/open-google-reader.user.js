...
function ui() {
  ...
  function addEntry(item, index){
    ...
    try {
      ...
      // check if entry needs alteration
      settings.entryDomAlterations.invoke('call', null, item, entry);
  ...
  function transformEntry(item) {
    ...
    feed = {
      ...
      category: feed && feed.categories && feed.categories[0] || ''
    };
    ...
    item = {
      ...
      enclosure: item.related && item.related[0] && item.related[0].href,
